...
### 2-2. 프로젝트 소개
한국환경공단의 전기자동차 충전소 데이터와 ChargeInfo의 전기차 등록 현황의 연도별 추이 데이터를 활용하여 전기차 등록은 증가하는 한편, 충전 인프라의 접근성이 분산되어있다는 점을 토대로 하여 전기차 사용자들이 보다 접근성이 좋은 전기차 충전소를 용이하게 확인할 수 있게 Streamlit을 통해 구현한 것이다.
...
https://github.com/user-attachments/assets/430d0cb1-7510-4556-9b57-233f9fb85fbc
...
- 연령대, 성별에 따른 전기차 등록 현황도 추가할 수 있도록 개선한다.
