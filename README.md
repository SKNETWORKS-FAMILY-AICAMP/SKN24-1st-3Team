...
### 2-2. 프로젝트 소개
한국환경공단의 전기자동차 충전소 데이터와 ChargeInfo의 전기차 등록 현황의 연도별 추이 데이터를 통해 전기차 등록은 증가하는 한편, 충전 인프라의 접근성이 부족하다는 것을 근거로 전기차 사용자들이 전기차 충전소를 용이하게 확인할 수 있게 Streamlit을 통해 구현하였다.
